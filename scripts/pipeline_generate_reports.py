...
# DAG_TAGS: [data_processing, etl, analytics]
# DAG_RETRIES: 2
# DAG_RETRY_DELAY: 60
# DAG_DESCRIPTION: Ежедневная обработка данных аналитики
...
def extract_sales_data(date_filter: str = None):
    """
...
def detect_anomalies(sales_df, revenue_metrics):
    """
...
def generate_daily_report(sales_df, revenue_metrics, anomalies):
    """
...
def send_report_to_storage(daily_report):
    """
...
def archive_old_reports(days_to_keep: int = 30):
    """
