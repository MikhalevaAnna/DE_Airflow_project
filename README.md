...
- `/screenshots/` - локальная папка со скриншотами того, что **DAGs** отработали успешно.</br>
...
Скриншоты успешной работы **DAGs** лежат в папке screenshots. </br>
...
- Нет вызовов других функций, которые находятся в том же файле. </br>
...
- Убедитесь в наличии и доступности подключений.
